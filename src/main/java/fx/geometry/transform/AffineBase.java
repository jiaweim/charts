...
import fx.geometry.*;
import fx.geometry.tools.NonInvertibleTransformException;
...
public abstract class AffineBase extends BaseTransform {
    ...
    @Override
    public double getMxx() {return mxx;}
    ...
    @Override
    public double getMxt() {return mxt;}

    @Override
    public double getMyt() {return myt;}
