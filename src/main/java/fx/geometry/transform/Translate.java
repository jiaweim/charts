...
public class Translate extends BaseTransform {
    ...
    @Override
    public void transform(Rectangle rect, Rectangle result) {transform(rect, result, mxt, myt);}
    ...
    @Override
    public Shape createTransformedShape(Shape s) {return new Path(s, this);}

    @Override
    public void setToIdentity() {this.mxt = this.myt = 0.0;}
    ...
    @Override
    public BaseTransform createInverse() {return isIdentity() ? IDENTITY_TRANSFORM : new Translate(-this.mxt, -this.myt);}

    private static double _matRound(double value) {return Math.rint(value * 1E15) / 1E15;}

    @Override
    public BaseTransform copy() {return new Translate(this.mxt, this.myt);}
