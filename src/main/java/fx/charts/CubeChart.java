...
import fx.charts.tools.P2d;
import fx.charts.tools.P3d;
import fx.charts.tools.PMatrix;
...
public class CubeChart extends Region {
    ...
    public CubeChart() {
        ...
        leftValue = new DoublePropertyBase(0) {
            ...
            @Override
            public Object getBean() {return CubeChart.this;}

            @Override
            public String getName() {return "leftValue";}
        };
        ...
        leftText = new StringPropertyBase("") {
            ...
            @Override
            public String getName() {return "leftText";}
        };
        rightText = new StringPropertyBase("") {
            ...
            @Override
            public String getName() {return "rightText";}
        };
        lineWidth = 10;
        cubeSize = 100;
    ...
    public ObjectProperty<Color> cubeColorProperty() {
        if (null == cubeColor) {
            cubeColor = new ObjectPropertyBase<>(_cubeColor) {
                ...
                @Override
                public String getName() {return "cubeColor";}
            };
            _cubeColor = null;
        }
        return cubeColor;
    ...
    public ObjectProperty<Color> cubeFrameColorProperty() {
        if (null == cubeFrameColor) {
            cubeFrameColor = new ObjectPropertyBase<>(_cubeFrameColor) {
                ...
                @Override
                public String getName() {return "cubeFrameColor";}
            };
    ...
    public ObjectProperty<Paint> leftFillProperty() {
        if (null == leftFill) {
            leftFill = new ObjectPropertyBase<>(_leftFill) {
                ...
                @Override
                public String getName() {return "leftFill";}
            };
            _leftFill = null;
        }
        return leftFill;
    ...
    public ObjectProperty<Paint> rightFillProperty() {
        if (null == rightFill) {
            rightFill = new ObjectPropertyBase<>(_rightFill) {
                ...
                @Override
                public String getName() {return "rightFill";}
            };
            _rightFill = null;
        }
        return rightFill;
    ...
    public ObjectProperty<Color> leftTextColorProperty() {
        if (null == leftTextColor) {
            leftTextColor = new ObjectPropertyBase<>(_leftTextColor) {
                ...
                @Override
                public String getName() {return "leftTextColor";}
            };
            _leftTextColor = null;
        }
    ...
    public ObjectProperty<Color> leftEmptyTextColorProperty() {
        if (null == leftEmptyTextColor) {
            leftEmptyTextColor = new ObjectPropertyBase<>(_leftEmptyTextColor) {
                ...
                @Override
                public String getName() {return "leftEmptyTextColor";}
            };
    ...
    public ObjectProperty<Color> rightEmptyTextColorProperty() {
        if (null == rightEmptyTextColor) {
            rightEmptyTextColor = new ObjectPropertyBase<>(_rightEmptyTextColor) {
                ...
                @Override
                public String getName() {return "rightEmptyTextColor";}
            };
    ...
    public ObjectProperty<Color> rightTextColorProperty() {
        if (null == rightTextColor) {
            rightTextColor = new ObjectPropertyBase<>(_rightTextColor) {
                ...
                @Override
                public String getName() {return "rightTextColor";}
            };
    ...
    protected void drawChart() {
        ...
        for (int i = 0; i < leftPoints.size(); i++) {
            ...
            switch (i) {
                case 0 -> {
                    point.x = -dataAreaSize;
                    point.y = -dataAreaSize;
                    point.z = -dataAreaSize;
                } // lower top left  index 0
                case 1 -> {
                    point.x = dataAreaSize;
                    point.y = -dataAreaSize;
                ...
                case 6 -> {
                    point.x = dataAreaSize;
                    point.y = dataAreaSize;
                    point.z = dataAreaSize - (2 * dataAreaSize * (1.0 - leftValue));
                }  // upper bottom right
                case 7 -> {
                    point.x = -dataAreaSize;
                    point.y = dataAreaSize;
        ...
        for (int i = 0; i < rightPoints.size(); i++) {
            ...
            switch (i) {
                ...
                case 5 -> {
                    point.x = dataAreaSize;
                    point.y = -dataAreaSize;
                    point.z = dataAreaSize - (2 * dataAreaSize * (1.0 - rightValue));
                }  // upper top right
                case 6 -> {
                    point.x = dataAreaSize;
                    point.y = dataAreaSize;
