...
import fx.charts.data.MapConnection;
import fx.charts.data.WeightedMapPoints;
import fx.charts.tools.MapPoint;
import fx.charts.tools.MapPointSize;
import fx.charts.world.World.Resolution;
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "mouseEnterHandler" ->
                        control.setMouseEnterHandler(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "mousePressHandler" ->
                        control.setMousePressHandler(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "mouseReleaseHandler" ->
                        control.setMouseReleaseHandler(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "mouseExitHandler" ->
                        control.setMouseExitHandler(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                ...
                case "mapConnections" ->
                        control.setMapConnections(((ObjectProperty<List<MapConnection>>) property).get());
                case "weightedMapPoints" ->
                        control.setWeightedMapPoints(((ObjectProperty<WeightedMapPoints>) property).get());
