        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "comparisonCategorySumColor" ->
                        control.setComparisonCategorySumColor(((ObjectProperty<Color>) property).get());
                case "comparisonSeriesNameColor" ->
                        control.setComparisonSeriesNameColor(((ObjectProperty<Color>) property).get());
                case "comparisonSeriesSumColor" ->
                        control.setComparisonSeriesSumColor(((ObjectProperty<Color>) property).get());
            }
        });
        return control;
    }
