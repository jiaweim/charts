...
import fx.charts.PixelMatrix.PixelShape;
import fx.charts.data.MatrixItem;
import fx.charts.series.MatrixItemSeries;
    ...
    public ObjectProperty<Paint> chartBackgroundProperty() {
        if (null == chartBackground) {
            chartBackground = new ObjectPropertyBase<Paint>(_chartBackground) {
                ...
                @Override
                public Object getBean() {return MatrixPane.this;}
    ...
    public DoubleProperty lowerBoundZProperty() {
        if (null == lowerBoundZ) {
            lowerBoundZ = new DoublePropertyBase(_lowerBoundZ) {
                ...
                @Override
                public String getName() {return "lowerBoundZ";}
            };
        }
        return lowerBoundZ;
    }
    ...
    public DoubleProperty upperBoundZProperty() {
        if (null == upperBoundZ) {
            upperBoundZ = new DoublePropertyBase(_upperBoundZ) {
                ...
                @Override
                public String getName() {return "upperBoundZ";}
            };
        }
        return upperBoundZ;
    }
