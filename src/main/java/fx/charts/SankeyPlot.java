...
import fx.charts.data.Connection;
import fx.charts.data.PlotItem;
import fx.charts.event.ChartEvt;
import fx.charts.tools.Helper;
import fx.geometry.Path;
...
public class SankeyPlot extends Region {
    ...
    public ObjectProperty<StreamFillMode> streamFillModeProperty() {
        if (null == streamFillMode) {
            streamFillMode = new ObjectPropertyBase<StreamFillMode>(_streamFillMode) {
                ...
                @Override
                public Object getBean() {return SankeyPlot.this;}

                @Override
                public String getName() {return "streamFillMode";}
            };
    ...
    public ObjectProperty<Color> streamColorProperty() {
        if (null == streamColor) {
            streamColor = new ObjectPropertyBase<Color>(_streamColor) {
                ...
                @Override
                public String getName() {return "streamColor";}
            };
            _streamColor = null;
        }
        return streamColor;
    ...
    public ObjectProperty<Color> textColorProperty() {
        if (null == textColor) {
            textColor = new ObjectPropertyBase<Color>(_textColor) {
                @Override
                protected void invalidated() {prepareData();}
    ...
    public IntegerProperty itemWidthProperty() {
        if (null == itemWidth) {
            itemWidth = new IntegerPropertyBase(_itemWidth) {
                ...
                @Override
                public String getName() {return "itemWidth";}
            };
        }
        return itemWidth;
    }
    ...
    public BooleanProperty autoItemWidthProperty() {
        if (null == autoItemWidth) {
            autoItemWidth = new BooleanPropertyBase(_autoItemWidth) {
                ...
                @Override
                public String getName() {return "autoItemWidth";}
            };
        }
    ...
    public IntegerProperty itemGapProperty() {
        if (null == itemGap) {
            itemGap = new IntegerPropertyBase(_itemGap) {
                ...
                @Override
                public String getName() {return "itemGap";}
            };
        }
        return itemGap;
    }
    ...
    public BooleanProperty autoItemGapProperty() {
        if (null == autoItemGap) {
            autoItemGap = new BooleanPropertyBase(_autoItemGap) {
                ...
                @Override
                public String getName() {return "autoItemGap";}
            };
        }
        return autoItemGap;
    }
    ...
    public BooleanProperty showFlowDirectionProperty() {
        if (null == showFlowDirection) {
            showFlowDirection = new BooleanPropertyBase(_showFlowDirection) {
                ...
                @Override
                public String getName() {return "showFlowDirection";}
            };
        }
    ...
    public BooleanProperty useItemColorProperty() {
        if (null == useItemColor) {
            useItemColor = new BooleanPropertyBase(_useItemColor) {
                ...
                @Override
                public String getName() {return "useItemColor";}
            };
        }
        return useItemColor;
    }
    ...
    public ObjectProperty<Color> itemColorProperty() {
        if (null == itemColor) {
            itemColor = new ObjectPropertyBase<Color>(_itemColor) {
                ...
                @Override
                public String getName() {return "itemColor";}
            };
        }
        return itemColor;
    }
    ...
    public ObjectProperty<Color> selectionColorProperty() {
        if (null == selectionColor) {
            selectionColor = new ObjectPropertyBase<>(_selectionColor) {
                ...
                @Override
                public String getName() {return "selectionColor";}
            };
    ...
    public BooleanProperty useCustomFontProperty() {
        if (null == useCustomFont) {
            useCustomFont = new BooleanPropertyBase(_useCustomFont) {
                ...
                @Override
                public String getName() {return "useCustomFont";}
            };
        }
    ...
    public ObjectProperty<Font> customFontProperty() {
        if (null == customFont) {
            customFont = new ObjectPropertyBase<>(_customFont) {
                ...
                @Override
                public String getName() {return "customFont";}
            };
            _customFont = null;
        }
        return customFont;
    ...
    public BooleanProperty useItemTextColorProperty() {
        if (null == useItemTextColor) {
            useItemTextColor = new BooleanPropertyBase(_useItemTextColor) {
                ...
                @Override
                public String getName() {return "useItemTextColor";}
            };
        }
    ...
    public BooleanProperty autoAdjustVerticalTextPositionProperty() {
        if (null == autoAdjustVerticalTextPosition) {
            autoAdjustVerticalTextPosition = new BooleanPropertyBase(_autoAdjustVerticalTextPosition) {
                ...
                @Override
                public String getName() {return "autoAdjustVerticalTextPosition";}
            };
        }
    ...
    private void prepareData() {
        if (!validateData(items)) {
            throw new IllegalArgumentException("Data not consistent. Please check the levels of the PlotItems");
        }
        ...
        for (int level = minLevel; level <= maxLevel; level++) {
            ...
            for (PlotItemData itemData : itemsPerLevel.get(level)) {
                ...
                switch (item.getVerticalTextPosition()) {
                    case TOP ->
                            itemData.setTextPoint(spacerX + textOffsetX, (height - itemHeight + fontSize * 0.5) - spacerY);
            ...
            for (PlotItemData itemData : itemDataInLevel) {
                ...
                if (getAutoAdjustVerticalTextPosition()) {
                    if (level >= maxLevel - 1) {
                        ...
                        if (level == maxLevel - 1) {
                            textBoundsMap.put(item, textBounds);
                        }
                        ...
                        if (optOverlap.isPresent() && level == maxLevel) {
                            ...
                            switch (item.getVerticalTextPosition()) {
                                ...
                                default ->
                                        calculatedTextPointY = (itemData.getTextPoint().getY() > height * 0.5) ? (height - fontSize * 0.5) - spacerY : (height - itemHeight + fontSize * 0.5) - spacerY;
                            }
                        } else {
                            overlap = false;
                        }
