...
import fx.charts.event.TreeNodeEvt;
import fx.charts.tools.Helper;
import fx.charts.tools.InfoPopup;
import fx.charts.tools.TextOrientation;
import fx.charts.tools.VisibleData;
import fx.geometry.Circle;
...
import static fx.charts.tools.Helper.clamp;
    ...
    public ObjectProperty<VisibleData> visibleDataProperty() {
        if (null == visibleData) {
            visibleData = new ObjectPropertyBase<>(_visibleData) {
                ...
                @Override
                public Object getBean() {return RadialTidyTree.this;}

                @Override
                public String getName() {return "visibleData";}
            };
            _visibleData = null;
        }
        return visibleData;
    ...
    public BooleanProperty useColorFromParentProperty() {
        if (null == useColorFromParent) {
            useColorFromParent = new BooleanPropertyBase(_useColorFromParent) {
                ...
                @Override
                public String getName() {return "useColorFromParent";}
            };
        }
    ...
    public ObjectProperty<Color> brightTextColorProperty() {
        if (null == brightTextColor) {
            brightTextColor = new ObjectPropertyBase<Color>(_brightTextColor) {
                ...
                @Override
                public String getName() {return "brightTextColor";}
            };
    ...
    public ObjectProperty<Color> darkTextColorProperty() {
        if (null == darkTextColor) {
            darkTextColor = new ObjectPropertyBase<Color>(_darkTextColor) {
                ...
                @Override
                public String getName() {return "darkTextColor";}
            };
            _darkTextColor = null;
        }
    ...
    public BooleanProperty useChartItemTextColor() {
        if (null == useChartItemTextColor) {
            useChartItemTextColor = new BooleanPropertyBase(_useChartItemTextColor) {
                ...
                @Override
                public String getName() {return "useChartItemTextColor";}
            };
        }
    ...
    private void drawChart() {
        ...
        for (int level = 1; level <= maxLevel; level++) {
            ...
            for (int i = 0; i < nodesInCurrentLevel.size(); i++) {
                ...
                if (level < maxLevel && currentNode.isLeaf()) {
                ...
                if (getVisibleData() != VisibleData.NONE) {
                    ...
                    switch (getVisibleData()) {
                        ...
                        case NAME_VALUE ->
                                text = String.join("", item.getName(), " (", String.format(Locale.US, formatString, item.getValue()), ")");
                    }
