...
public class ObservableList<T> implements List<T>, RandomAccess, Cloneable {
    ...
    @Override
    public boolean contains(final Object obj) {return list.contains(obj);}

    @Override
    public boolean containsAll(final Collection<?> collection) {return list.containsAll(collection);}
    ...
    @Override
    public <U> U[] toArray(final U[] a) {return list.toArray(a);}
    ...
    @Override
    public boolean equals(final Object obj) {return list.equals(obj);}
    ...
    public boolean removeIf(final Predicate<? super T> filter) {
        ...
        if (result) {
            fireListChangeEvt(new ListChangeEvt<>(ObservableList.this, ListChangeEvt.REMOVED, null, null));
        }
        return result;
    }
