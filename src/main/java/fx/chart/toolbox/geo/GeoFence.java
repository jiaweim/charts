...
import fx.chart.toolbox.evt.type.GeoFenceEvt;
...
public class GeoFence {
    ...
    private fx.chart.toolbox.geo.Polygon polygon;
    ...
    // ******************** Constructor ***************************************
    public GeoFence() {
        this("", "", "", false, false, LocalTime.now(), LocalTime.now(), ZoneId.systemDefault(), new HashSet<>(), new HashSet<>(), new fx.chart.toolbox.geo.Polygon());
    }

    public GeoFence(final String name, final String info, final String group, final boolean active, final boolean timeBased, final LocalTime startTime, final LocalTime endTime, final ZoneId zoneId, final Set<DayOfWeek> days, final Set<String> tags, final fx.chart.toolbox.geo.Polygon polygon) {
    ...
    public fx.chart.toolbox.geo.Polygon getPolygon() {return polygon;}

    public void setPolygon(final fx.chart.toolbox.geo.Polygon polygon) {
