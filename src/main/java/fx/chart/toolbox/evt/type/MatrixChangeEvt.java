...
public class MatrixChangeEvt<T> extends fx.chart.toolbox.evt.type.ChangeEvt {
    ...
    // ******************** Methods *******************************************
    @Override
    public EvtType<? extends MatrixChangeEvt<T>> getEvtType() {return (EvtType<? extends MatrixChangeEvt<T>>) super.getEvtType();}
