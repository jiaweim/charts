...
import fx.chart.toolbox.geo.GeoFence;
import fx.chart.toolbox.geo.GeoLocation;
import fx.chart.toolbox.geo.Polygon;
...
public class GeoFenceEvt extends fx.chart.toolbox.evt.type.ChangeEvt {
    ...
    // ******************** Methods *******************************************
    @Override
    public EvtType<? extends GeoLocationChangeEvt> getEvtType() {return (EvtType<? extends GeoLocationChangeEvt>) super.getEvtType();}
