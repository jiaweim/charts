...
import fx.chart.util.CornerRadii;
...
public class PixelMatrix extends Region {
    ...
    public void drawMatrix() {
        ...
        switch (pixelShape) {
            case ROUNDED_RECT:
                fx.chart.util.Bounds bounds = new fx.chart.util.Bounds(pixelWidthMinusDoubleSpacer, pixelHeightMinusDoubleSpacer);
    ...
    public void addPixelMatrixEventListener(final PixelMatrixEventListener LISTENER) {
        if (!listeners.contains(LISTENER)) listeners.add(LISTENER);
    }

    public void removePixelMatrixEventListener(final PixelMatrixEventListener LISTENER) {
    ...
    public void firePixelMatrixEvent(final PixelMatrixEvt EVENT) {
        for (PixelMatrixEventListener listener : listeners) {
