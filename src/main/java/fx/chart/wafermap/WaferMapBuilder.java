...
public class WaferMapBuilder<B extends WaferMapBuilder<B>> {
    ...
    public final WaferMap build() {
        ...
        if (properties.keySet().contains("kla")) {
            control.setKla(((ObjectProperty<KLA>) properties.get("kla")).get());
        }
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "heatmapColorMapping" ->
                        control.setHeatmapColorMapping(((ObjectProperty<ColorMapping>) property).get());
                ...
                case "classConfigMap" ->
                        control.setClassConfigMap(((ObjectProperty<Map<Integer, ClassConfig>>) property).get());
            }
        });
        return control;
    }
