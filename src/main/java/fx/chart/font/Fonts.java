...
/**
 * Class used to load embedded fonts.
 */
public class Fonts {
    ...
    static {
        try {
            latoLightName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/Lato-Lig.otf"), 10).getName();
            latoRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/Lato-Reg.otf"), 10).getName();
            latoBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/Lato-Bol.otf"), 10).getName();
            openSansBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/OpenSans-Bold.ttf"), 10).getName();
            openSansExtraBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/OpenSans-ExtraBold.ttf"), 10).getName();
            openSansLightName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/OpenSans-Light.ttf"), 10).getName();
            openSansRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/OpenSans-Regular.ttf"), 10).getName();
            openSansSemiboldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/OpenSans-Semibold.ttf"), 10).getName();
            cousineRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/Cousine-Regular.ttf"), 10).getName();
            cousineBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/Cousine-Bold.ttf"), 10).getName();
            mazzardsoftlBlackName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Black.otf"), 10).getName();
            mazzardsoftlBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Bold.otf"), 10).getName();
            mazzardsoftlExtraBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-ExtraBold.otf"), 10).getName();
            mazzardsoftlExtraLightName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-ExtraLight.otf"), 10).getName();
            mazzardsoftlLightName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Light.otf"), 10).getName();
            mazzardsoftlMediumName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Medium.otf"), 10).getName();
            mazzardsoftlRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Regular.otf"), 10).getName();
            mazzardsoftlSemiBoldName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-SemiBold.otf"), 10).getName();
            mazzardsoftlThinName = Font.loadFont(Fonts.class.getResourceAsStream("/fx/chart/font/MazzardSoftL-Thin.otf"), 10).getName();
