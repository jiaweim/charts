...
import fx.chart.event.type.GeoFenceEvt;
...
public class GeoFence {
    ...
    private fx.chart.util.geo.Polygon polygon;
    private HashMap<String, GeoLocation> objectsInFence;
    private Map<EvtType, List<EvtObserver<GeoFenceEvt>>> observers;

    public GeoFence() {
        this("", "", "", false, false, LocalTime.now(), LocalTime.now(), ZoneId.systemDefault(), new HashSet<>(), new HashSet<>(), new fx.chart.util.geo.Polygon());
    }

    public GeoFence(final String name, final String info, final String group, final boolean active, final boolean timeBased, final LocalTime startTime, final LocalTime endTime, final ZoneId zoneId, final Set<DayOfWeek> days, final Set<String> tags, final fx.chart.util.geo.Polygon polygon) {
    ...
    public fx.chart.util.geo.Polygon getPolygon() {return polygon;}

    public void setPolygon(final fx.chart.util.geo.Polygon polygon) {
