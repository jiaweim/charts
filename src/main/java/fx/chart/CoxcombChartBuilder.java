    ...
    public final CoxcombChart build() {
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "onMousePressed" ->
                        control.onMousePressed(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "onMouseReleased" ->
                        control.onMouseReleased(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
                case "onMouseMoved" ->
                        control.onMouseMoved(((ObjectProperty<EventHandler<MouseEvent>>) property).get());
