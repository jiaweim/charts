...
public class Constants {
     ...
     */
    public static final String BOUNDS_PROPERTIES = "bounds.properties";
    /**
     * Properties file that contains high resolution svg paths for all countries
     */
    public static final String HIRES_PROPERTIES = "hires.properties";
    /**
     * Properties file that contains low resolution svg paths for all countries
     */
    public static final String LORES_PROPERTIES = "lores.properties";
