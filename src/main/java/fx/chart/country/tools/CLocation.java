...
public class CLocation extends Location {
    ...
    public void set(final CLocation location) {
        ...
        if (null == connectionPartType) {
            connectionPartType = location.getConnectionPartType();
        } else {
            connectionPartType = ConnectionPartType.NONE;
        }
        fireEvt(UPDATE_EVENT);
    ...
    public void addEvtObserver(final EvtObserver<CountryEvt<CLocation>> observer) {
        if (!observers.contains(observer)) observers.add(observer);
    }

    public void removeEvtObserver(final EvtObserver<CountryEvt<CLocation>> observer) {
