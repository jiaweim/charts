...
public class RegionPaneBuilder<B extends RegionPaneBuilder<B>> {
    ...
    public static RegionPaneBuilder create(final CRegion region) {return new RegionPaneBuilder(region);}
        ...
        properties.forEach((key, property) -> {
            switch (key) {
                ...
                case "heatmapColorMapping" ->
                        control.setHeatmapColorMapping(((ObjectProperty<Mapping>) property).get());
                ...
                case "heatmapOpacityDistribution" ->
                        control.setHeatmapOpacityDistribution(((ObjectProperty<OpacityDistribution>) property).get());
