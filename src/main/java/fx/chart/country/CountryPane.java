...
public class CountryPane extends Region implements EvtObserver<CountryEvt<Connection>> {
    ...
    public ObjectProperty<Color> fillProperty() {
        if (null == fill) {
            fill = new ObjectPropertyBase<>(_fill) {
                ...
                @Override
                public Object getBean() {return CountryPane.this;}
    ...
    public ObjectProperty<Color> poiFillProperty() {
        if (null == poiFill) {
            poiFill = new ObjectPropertyBase<>(_poiFill) {
                ...
                @Override
                public String getName() {return "poiFill";}
            };
            _poiFill = null;
        }
        return poiFill;
    ...
    public ObjectProperty<Color> poiStrokeProperty() {
        if (null == poiStroke) {
            poiStroke = new ObjectPropertyBase<>(_poiStroke) {
                ...
                @Override
                public String getName() {return "poiStroke";}
            };
            _poiStroke = null;
        }
        return poiStroke;
    ...
    public BooleanProperty poisVisibleProperty() {
        if (null == poisVisible) {
            poisVisible = new BooleanPropertyBase(_poisVisible) {
                ...
                @Override
                public String getName() {return "poisVisible";}
            };
        }
        return poisVisible;
    }
    ...
    public BooleanProperty poiTextVisibleProperty() {
        if (null == poiTextVisible) {
            poiTextVisible = new BooleanPropertyBase(_poiTextVisible) {
                ...
                @Override
                public String getName() {return "poiTextVisible";}
            };
        }
    ...
    public ObjectProperty<Color> poiTextFillProperty() {
        if (null == poiTextFill) {
            poiTextFill = new ObjectPropertyBase<>(_poiTextFill) {
                ...
                @Override
                public String getName() {return "poiTextFill";}
            };
            _poiTextFill = null;
        }
        return poiTextFill;
    ...
    @Override
    public void handle(final CountryEvt<Connection> evt) {
        EvtType<? extends Evt> type = evt.getEvtType();
        if (CountryEvt.UPDATE.equals(type)) {
            if (overlay.isVisible()) {
                redrawOverlay();
            }
        } else if (CountryEvt.SELECTED.equals(type)) {
            if (overlay.isVisible()) {
                redrawOverlay();
            }
        }
    ...
    private void redrawOverlay() {
        ...
        for (Connection connection : connections) {
            ...
            xy1.translateBy(-countryOffsetX, -countryOffsetY);
            xy1.scaleBy(scaleX, scaleY);
            xy2.translateBy(-countryOffsetX, -countryOffsetY);
            xy2.scaleBy(scaleX, scaleY);
            midPoint.translateBy(-countryOffsetX, -countryOffsetY);
            midPoint.scaleBy(scaleX, scaleY);
            midPoint1.translateBy(-countryOffsetX, -countryOffsetY);
            midPoint1.scaleBy(scaleX, scaleY);
            midPoint2.translateBy(-countryOffsetX, -countryOffsetY);
            midPoint2.scaleBy(scaleX, scaleY);
            rotCp1.translateBy(-countryOffsetX, -countryOffsetY);
            rotCp1.scaleBy(scaleX, scaleY);
            rotCp2.translateBy(-countryOffsetX, -countryOffsetY);
