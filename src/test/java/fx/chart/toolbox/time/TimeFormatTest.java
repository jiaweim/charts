...
public class TimeFormatTest {
    ...
    void testTimeFormats() {
        ...
        assert "12:03:00.0000".equals(fx.chart.toolbox.time.Times.HH_mm_ss_SSSS.format(time));
        assert "12:03".equals(fx.chart.toolbox.time.Times.HH_mm.format(time));
        assert "120300".equals(fx.chart.toolbox.time.Times.HHmmss.format(time));
