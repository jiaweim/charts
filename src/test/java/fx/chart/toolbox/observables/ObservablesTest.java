...
public class ObservablesTest {
    ...
    void testObservableList() {
        ...
        fx.chart.toolbox.observables.ObservableList<String> observableList = new ObservableList<>();
    ...
    void testObservableMap() {
        System.out.println("\n-------------------- observable map demo --------------------");
        fx.chart.toolbox.observables.ObservableMap<String, Integer> observableMap = new ObservableMap<>();
    ...
    void testObservableMatrix() {
        ...
        final int cols = 3;
        final int rows = 2;
        fx.chart.toolbox.observables.ObservableMatrix<Integer> integerMatrix = new ObservableMatrix<>(Integer.class, cols, rows);
