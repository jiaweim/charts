...
public class UnitTest {
    ...
    void testUnit() {
        System.out.println("\n-------------------- converter demo --------------------");
        fx.chart.toolbox.unit.Converter temperatureConverter = new fx.chart.toolbox.unit.Converter(TEMPERATURE, CELSIUS); // Type Temperature with BaseUnit Celsius
        double    celsius              = 32.0;
        ...
        fx.chart.toolbox.unit.Converter lengthConverter = new fx.chart.toolbox.unit.Converter(LENGTH, METER); // Type Length with BaseUnit Meter
        double    meter           = 1.0;
        ...
        fx.chart.toolbox.unit.Converter volumeConverter = new fx.chart.toolbox.unit.Converter(VOLUME, CUBIC_METER);
        double    cubicMeter      = 3;
        ...
        fx.chart.toolbox.unit.Converter literConverter = new fx.chart.toolbox.unit.Converter(VOLUME, LITER);
        double liter = 3000;
        double cubicMeters = literConverter.convert(liter, CUBIC_METER);

        assert Double.compare(3.0, cubicMeter) == 0;

        fx.chart.toolbox.unit.Converter glucoseConverter = new fx.chart.toolbox.unit.Converter(BLOOD_GLUCOSE, MILLIMOL_PER_LITER);
        ...
        fx.chart.toolbox.unit.Converter mgdlConverter = new fx.chart.toolbox.unit.Converter(BLOOD_GLUCOSE, MILLIGRAM_PER_DECILITER);
        ...
        assert fx.chart.toolbox.unit.Converter.format(1_500_000, 1).equals("1.5M");
